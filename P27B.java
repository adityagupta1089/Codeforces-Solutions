    ...
    static class Task {
            ...
            for (int i = 1; i <= n; i++) {
                for (int j = i + 1; j <= n; j++) {
                    if (!st.contains(new Pair(i, j))) {
                        if (reachable(i, j, adj)) out.println(i + " " + j);
                        else /*if (reachable(j, i, adj))*/ out.println(j + " " + i);
                        return;
                    }
                }
            }
        ...
        public static class Pair {
            ...
            public boolean equals(Object obj) {
                Pair other = (Pair) obj;
                if (Math.min(a, b) != Math.min(other.a, other.b)) return false;
                if (Math.max(a, b) != Math.max(other.a, other.b)) return false;
                return true;
            }
